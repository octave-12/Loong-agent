...
from loongpearl.learning.seeder import OllamaSeeder, AssociationGenerator, OllamaClient
...
# 默认路径
DEFAULT_MODEL_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))  # Loong-pearl/ 项目根
DEFAULT_ZICHANG = os.path.join(DEFAULT_MODEL_DIR, "data/models/zichang_94117_1024d.pt")
DEFAULT_LANDSCAPE = os.path.join(DEFAULT_MODEL_DIR, "data/models/energy_landscape_1024d.pt")
DEFAULT_FREQ_FILE = os.path.join(DEFAULT_MODEL_DIR, "data/wordlists/hanzi_top3500.txt")
DEFAULT_PROGRESS = os.path.join(DEFAULT_MODEL_DIR, "data/runtime/seed_progress.json")
